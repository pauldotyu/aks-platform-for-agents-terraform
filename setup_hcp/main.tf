...
resource "azuread_application_federated_identity_credential" "dev_plan" {
  ...
  subject   = "organization:${var.hcp_organization_name}:project:${var.hcp_project_name}:stack:${var.hcp_stack_name}:deployment:dev:operation:plan"
}
...
resource "azuread_application_federated_identity_credential" "dev_apply" {
  ...
  audiences = [var.azure_audience]
  issuer    = "https://${var.hcp_hostname}"
  subject   = "organization:${var.hcp_organization_name}:project:${var.hcp_project_name}:stack:${var.hcp_stack_name}:deployment:dev:operation:apply"
}
...
resource "azuread_application_federated_identity_credential" "prod_plan" {
  ...
  audiences = [var.azure_audience]
  issuer    = "https://${var.hcp_hostname}"
  subject   = "organization:${var.hcp_organization_name}:project:${var.hcp_project_name}:stack:${var.hcp_stack_name}:deployment:prod:operation:plan"
}
...
resource "azuread_application_federated_identity_credential" "prod_apply" {
  ...
  audiences = [var.azure_audience]
  issuer    = "https://${var.hcp_hostname}"
  subject   = "organization:${var.hcp_organization_name}:project:${var.hcp_project_name}:stack:${var.hcp_stack_name}:deployment:prod:operation:apply"
}
